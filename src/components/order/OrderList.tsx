      ...
      <div className="w-full sm:px-6">
        ...
        <div className="bg-white py-4 px-4 md:py-7 md:px-8 xl:px-10">
          <div className="items-center justify-between sm:flex">
            ...
            <button className="mt-4 inline-flex items-start justify-start rounded bg-indigo-700 px-6 py-3 hover:bg-indigo-600 focus:outline-none sm:mt-0">
            ...
            <table className="w-full whitespace-nowrap">
              <tbody>
                ...
                <tr className="h-16 rounded border border-gray-100">
                  ...
                  <td className="pl-5">
                    <button className="rounded bg-gray-100 py-3 px-6 text-sm leading-none text-gray-600 hover:bg-gray-200 focus:outline-none">
                      Due on 21.02.21
                    </button>
                  </td>
                  <td className="pl-4">
                ...
                <tr className="h-16 rounded border border-gray-100">
                  ...
                  <td className="pl-5">
                    <button className="rounded bg-gray-100 py-3 px-7 text-sm leading-none text-gray-600 hover:bg-gray-200 focus:outline-none">
                      Due tomorrow
                    </button>
                  </td>
                  <td className="pl-4">
                ...
                <tr className="h-16 rounded border border-gray-100">
                  ...
                  <td className="pl-5">
                    <button className="rounded bg-gray-100 py-3 px-3 text-sm leading-none text-gray-600 hover:bg-gray-200 focus:outline-none">
                      Due Today at 18:00
                    </button>
                  </td>
                  <td className="pl-4">
